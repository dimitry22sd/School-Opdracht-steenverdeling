...
//Nieuwe pagina
 ...
 // pdf.text("Aantal deuren: " + aantaldeuren + ".", center, 60);
 // pdf.text("Aantal ramen: " + aantalramen + ".", center, 70);
 pdf.setProperties({
...
if (raambreedte1 > 0 && raamhoogte1 > 0 || raambreedte2 > 0 && raamhoogte2 > 0) {
  pdf.text("U heeft 1 raam geselecteert", 20 , 110);
  document.getElementById('ramen-bestelling').style.display = "block";
  document.getElementById('ramen').innerHTML = "1";
}
else if (raambreedte2 > 0 && raamhoogte2 > 0 && raambreedte1 > 0 && raamhoogte1 > 0) {
  pdf.text("U heeft 2 ramen geselecteert", 20 , 110);
  document.getElementById('ramen-bestelling').style.display = "block";
...
doorPositionsValues.forEach((doorPosition, index) => {
  ...
  if (doorPositionsValues[1] > 0) {
    ...
    document.getElementById('deurpositie1').value = nieuwepositie;
  //  
  }
  if (doorPositionsValues[0] > 0) {
    ...
    document.getElementById('deurpositie2').value = nieuwepositie2;
  }
