...
//Nieuwe pagina
  ...
  pdf.setFontSize(15);
  pdf.setTextColor('black');
  pdf.text("Formaat: " + document.getElementById('formatenselectbox').value, 20, 120);
...
document.getElementById('steenafmeting').innerHTML = document.getElementById('formatenselectbox').value + " || " + steenDx + " X " + steenDy + " X " + steenDz;
...
let totaalbedrag = muurkosten + voegkosten + (steenafmetingkosten * aantalstenen) + deurkosten + patroonkosten + raamkosten + raamkosten2;
document.getElementById('aantal-stenen').innerHTML = "Aantal stenen: " + aantalstenen;
document.getElementById('aantal-stenen-prijs').innerHTML = "€ " + Math.trunc(aantalstenen * steenafmetingkosten);
...
let deur2positie = document.getElementById('deurpositie').value;
document.getElementById('deurpositie').value = document.getElementById('deurpositie2').value;
document.getElementById('deurpositie2').value = deur2positie;
};
//Collision detection 
